...
export function postJson(url, body, tags) {
  return http.post(url, stringifyBody(body), { headers: JSON_HEADERS, tags });
}

export function putJson(url, body, tags) {
  return http.put(url, stringifyBody(body), { headers: JSON_HEADERS, tags });
}

export function patchJson(url, body, tags) {
  return http.patch(url, stringifyBody(body), { headers: JSON_HEADERS, tags });
}
